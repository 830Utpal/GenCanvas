  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center text-center my-20'>
        <p className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded full border border-neutral-500'>
         Best text to image generator
        
        <img src={assets.star_icon} alt=""/> </p>
        </div>
        ...
        <p className='mt-2 text-neutral-600 flex flex-wrap justify-center'>Generated images from imagify</p>
    </div>
  )
}
