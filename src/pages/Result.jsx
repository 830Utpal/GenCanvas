...
const Result = () => {
  return (
    ...
    <div className='relative'>
      <img src={assers.sample_img_1} alt="" className='max-w-sm rounded'/>
      <span className='absolute bottom-0 left-0 h-1 bg-blue-500 w-full transition-all duration-[10s]'/>
    </div>
    <p>Loading.....</p>
    </div>
    <div className='flex w-full max-w-xl bg-neautral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
